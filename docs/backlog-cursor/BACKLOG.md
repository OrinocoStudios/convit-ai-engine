...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------ |
| **ID-1** | Definir si DNI/NSS es el `patientId` expuesto al Cerebro o un campo (`externalPatientId`) con mapeo al `_id` Mongo; unicidad por `tenantId`.                     | Claridad en la API y el esquema de Mongo; Pinky usa ID interno, pero buscamos por DNI.                 | **Hecho**   | [docs/code-explanation.md](../code-explanation.md), esquema `Patient` |
